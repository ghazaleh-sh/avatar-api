...
public class ContactExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleWebExchangeBindException(WebExchangeBindException e, Locale locale) {
    ...
    public ResponseEntity<ApiError> handleMissingRequestValueException(MissingRequestValueException e, Locale locale) {
    ...
    public ResponseEntity<ApiError> handleTypeMismatchException(TypeMismatchException e, Locale locale) {
    ...
    public ResponseEntity<ApiError> handleDataBufferLimitException(DataBufferLimitException e, Locale locale) {
    ...
    public ResponseEntity<ApiError> handleExceptions(Exception e, Locale locale) {
    ...
    private ApiError getErrorModel(BaseException exception) {
        return ApiError.builder()
                .status(exception.getHttpStatusCode())
                .message(this.getMessage(exception.getCode(), LOCALE_EN))
                .localizedMessage(this.getMessage(exception.getCode(), LOCALE_FA))
